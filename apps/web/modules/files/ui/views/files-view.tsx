...
import { DeletedFileDialog } from "../components/delete-file-dialog";
export const FilesView = () => {
  ...
  const [seletedFile, setSelectedFile] = useState<PublicFile | null>(null);
        ...
        <div className="mx-auto w-full max-w-screen-md">
          ...
          <div className="mt-4 rounded-lg border bg-background">
            <div className="flex items-center justify-end border-b px-6 py-4">
              <Button className="" onClick={() => setUploadDialogOpen(true)}>
                <PlusIcon />
                Add New
              </Button>
            </div>
